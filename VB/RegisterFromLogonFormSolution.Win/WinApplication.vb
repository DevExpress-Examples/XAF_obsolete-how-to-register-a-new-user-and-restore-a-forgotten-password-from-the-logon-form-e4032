...
Namespace RegisterFromLogonFormSolution.Win
	Partial Public Class RegisterFromLogonFormSolutionWindowsFormsApplication
		...
		Private Sub RegisterFromLogonFormSolutionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
